...
* **Open Hyperspec III back up (collect data from the SWIR):**
    * Open the **“file transfer”** tab.
    * Select your folders you want (All folders with the date stamp).
    * Set your target folder.
    * **DO NOT select create cube images.**
    * Click transfer and watch the progress bar.
    * Close HSIII.
* Disconnect Ethernet cables from the sensor.
* Close down computer with all data!
* **Turn off Controller and NavBay:**
    * Press & hold radio power button for 1 sec to turn off.
    * Press & hold power/lock button & volume down button until off (Or: swipe down twice until power button is visible on screen and turn off).
